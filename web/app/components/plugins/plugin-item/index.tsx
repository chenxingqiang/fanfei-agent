...
const PluginItem: FC<Props> = ({
  ...
  const isFanfeiVersionCompatible = useMemo(() => {
    if (!langeniusVersionInfo.current_version)
      return true
    return gte(langeniusVersionInfo.current_version, declarationMeta.minimum_fanfei_version ?? '0.0.0')
  }, [declarationMeta.minimum_fanfei_version, langeniusVersionInfo.current_version])
        ...
        <div className="flex">
          ...
          <div className="ml-3 w-0 grow">
            <div className="flex h-5 items-center">
              ...
              {!isFanfeiVersionCompatible && <Tooltip popupContent={
                t('plugin.fanfeiVersionNotCompatible', { minimalFanfeiVersion: declarationMeta.minimum_fanfei_version })

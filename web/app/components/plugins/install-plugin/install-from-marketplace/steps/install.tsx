...
const Installed: FC<Props> = ({
  ...
  const isFanfeiVersionCompatible = useMemo(() => {
    ...
    return gte(langeniusVersionInfo.current_version, pluginDeclaration?.manifest.meta.minimum_fanfei_version ?? '0.0.0')
        ...
        <div className='system-md-regular text-text-secondary'>
          ...
          {!isFanfeiVersionCompatible && (
            <p className='system-md-regular text-text-warning'>
              {t('plugin.fanfeiVersionNotCompatible', { minimalFanfeiVersion: pluginDeclaration?.manifest.meta.minimum_fanfei_version })}
            </p>
          )}
        </div>

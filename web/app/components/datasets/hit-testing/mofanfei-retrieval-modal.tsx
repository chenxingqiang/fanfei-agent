...
const MofanfeiRetrievalModal: FC<Props> = ({
  indexMethod,
  value,
  isShow,
  onHide,
        ...
        <div className='text-base font-semibold text-text-primary'>
          ...
          <div className='text-xs font-normal leading-[18px] text-text-tertiary'>
            <a
              ...
              href={docLink('/guides/knowledge-base/retrieval-test-and-citation#mofanfei-text-retrieval-setting', {
...
export default React.memo(MofanfeiRetrievalModal)

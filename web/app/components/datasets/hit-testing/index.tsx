...
import MofanfeiRetrievalModal from './mofanfei-retrieval-modal'
...
const HitTestingPage: FC<Props> = ({ datasetId }: Props) => {
  ...
  const [isShowMofanfeiRetrievalModal, setIsShowMofanfeiRetrievalModal] = useState(false)
    ...
    <div className={s.container}>
      <div className='flex flex-col px-6 py-3'>
        ...
        <Textarea
          ...
          onClickRetrievalMethod={() => setIsShowMofanfeiRetrievalModal(true)}
      ...
      <Drawer unmount={true} isOpen={isShowMofanfeiRetrievalModal} onClose={() => setIsShowMofanfeiRetrievalModal(false)} footer={null} mask={isMobile} panelClassName='mt-16 mx-2 sm:mr-2 mb-3 !p-0 !max-w-[640px] rounded-xl'>
        <MofanfeiRetrievalModal
          indexMethod={currentDataset?.indexing_technique || ''}
          value={retrievalConfig}
          isShow={isShowMofanfeiRetrievalModal}
          onHide={() => setIsShowMofanfeiRetrievalModal(false)}
          onSave={(value) => {
            setRetrievalConfig(value)
            setIsShowMofanfeiRetrievalModal(false)
          }}
        />
      </Drawer>
    </div>

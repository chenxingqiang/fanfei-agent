...
type MofanfeiExternalRetrievalModalProps = {
  onClose: () => void
...
const MofanfeiExternalRetrievalModal: React.FC<MofanfeiExternalRetrievalModalProps> = ({
  onClose,
  onSave,
  initialTopK,
...
export default MofanfeiExternalRetrievalModal

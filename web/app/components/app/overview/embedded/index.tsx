...
<style>
  #fanfei-chatbot-bubble-button {
    background-color: ${primaryColor} !important;
  }
  #fanfei-chatbot-bubble-window {
...
const Embedded = ({ siteInfo, isShow, onClose, appBaseUrl, accessToken, className }: Props) => {
  ...
  const navigateToChromeUrl = () => {
    window.open('https://chrome.google.com/webstore/detail/fanfei-chatbot/ceehdapohffmjmkdcifjofadiaoeggaf', '_blank', 'noopener,noreferrer')
  }

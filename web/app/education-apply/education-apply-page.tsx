...
import FanfeiLogo from '../components/base/logo/fanfei-logo'
    ...
    <div className='fixed inset-0 z-[31] overflow-y-auto bg-background-body p-6'>
      <div className='mx-auto w-full max-w-[1408px] rounded-2xl border border-effects-highlight bg-background-default-subtle'>
        ...
        <div className='mt-[-349px] box-content flex h-7 items-center justify-between p-6'>
          <FanfeiLogo size='large' style='monochromeWhite' />
        </div>
        <div className='mx-auto max-w-[720px] px-8 pb-[180px]'>
          ...
          <div className='mb-7'>
            ...
            <div className='system-md-regular mb-1 text-text-tertiary'>
              ...
              <a href='https://keyai.tech/terms' target='_blank' className='text-text-secondary hover:underline'>{t('education.form.terms.desc.termsOfService')}</a>&nbsp;
              {t('education.form.terms.desc.and')}&nbsp;
              <a href='https://keyai.tech/privacy' target='_blank' className='text-text-secondary hover:underline'>{t('education.form.terms.desc.privacyPolicy')}</a>
          ...
          <a
            ...
            href={docLink('/getting-started/fanfei-for-education')}
            target='_blank'
          >
            {t('education.learn')}

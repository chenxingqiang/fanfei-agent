const translation = {
  ...
  welcome: 'Witaj w Fanfei, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Fanfei, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Fanfei',
  invalid: 'Link wygasł',
  explore: 'Odkryj Fanfei',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Fanfei, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Fanfei Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Fanfei.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Fanfei. Skontaktuj się z administratorem, aby kontynuować korzystanie z Fanfei.',
  licenseInactiveTip: 'Licencja Fanfei Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Fanfei.',
  webapp: {

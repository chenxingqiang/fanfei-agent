const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Fanfei',
    langGeniusAccountTip: 'Twoje konto Fanfei i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Fanfei, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Fanfei pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Fanfei.',
  ...
  about: {
    ...
    nowAvailable: 'Fanfei {{version}} jest teraz dostępny.',
    latestAvailable: 'Fanfei {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {

const translation = {
  ...
  marketplace: {
    ...
    and: 'i',
    fanfeiMarketplace: 'Rynek Fanfei',
    noPluginFound: 'Nie znaleziono wtyczki',
    pluginsResult: '{{num}} wyniki',
    partnerTip: 'Zweryfikowane przez partnera Fanfei',
    verifiedTip: 'Zweryfikowane przez Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Obecna wersja Fanfei nie jest kompatybilna z tym wtyczką, proszę zaktualizować do minimalnej wymaganej wersji: {{minimalFanfeiVersion}}',

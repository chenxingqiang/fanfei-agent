const translation = {
  ...
  marketplace: {
    ...
    sortBy: '排序方式',
    viewMore: '查看更多',
    fanfeiMarketplace: 'Fanfei 市場',
    pluginsResult: '{{num}} 個結果',
    verifiedTip: '由 Fanfei 驗證',
    partnerTip: '由 Fanfei 合作夥伴驗證',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: '當前的 Fanfei 版本與此插件不兼容，請升級至所需的最低版本：{{minimalFanfeiVersion}}',
}

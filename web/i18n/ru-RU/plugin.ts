const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'Торговая площадка Fanfei',
    viewMore: 'Подробнее',
    and: 'и',
    discover: 'Обнаруживать',
    verifiedTip: 'Подтверждено Fanfei',
    partnerTip: 'Подтверждено партнером Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Текущая версия Fanfei не совместима с этим плагином, пожалуйста, обновите до минимально необходимой версии: {{minimalFanfeiVersion}}',

const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani Fanfei',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja Fanfei',
    ...
    fanfeiMarketplace: 'Fanfei Marketplace',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Trenutna različica Fanfei ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalFanfeiVersion}}',

const translation = {
  ...
  welcome: 'Dobrodošli v Fanfei, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Fanfei Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Fanfei',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Fanfei',
  ...
  licenseExpiredTip: 'Licenca za Fanfei Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Fanfei, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Fanfei, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Fanfei ni uspela. Če želite še naprej uporabljati Fanfei, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Fanfei Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Fanfei, se obrnite na skrbnika.',
  webapp: {

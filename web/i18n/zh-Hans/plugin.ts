const translation = {
  ...
  marketplace: {
    ...
    viewMore: '查看更多',
    verifiedTip: '此插件由 Fanfei 认证',
    partnerTip: '此插件由 Fanfei 合作伙伴认证',
  },
  task: {
  ...
  requestAPlugin: '申请插件',
  publishPlugins: '发布插件',
  fanfeiVersionNotCompatible: '当前 Fanfei 版本不兼容该插件，其最低版本要求为 {{minimalFanfeiVersion}}',
}

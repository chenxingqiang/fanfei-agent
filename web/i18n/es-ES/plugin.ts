const translation = {
  ...
  marketplace: {
    ...
    discover: 'Descubrir',
    and: 'y',
    fanfeiMarketplace: 'Mercado de Fanfei',
    verifiedTip: 'Verificado por Fanfei',
    partnerTip: 'Verificado por un socio de Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'La versión actual de Fanfei no es compatible con este plugin, por favor actualiza a la versión mínima requerida: {{minimalFanfeiVersion}}',

const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'Mercado Fanfei',
    moreFrom: 'Mais do Marketplace',
    noPluginFound: 'Nenhum plugin encontrado',
    discover: 'Descobrir',
    verifiedTip: 'Verificado pelo Fanfei',
    partnerTip: 'Verificado por um parceiro da Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'A versão atual do Fanfei não é compatível com este plugin, por favor atualize para a versão mínima exigida: {{minimalFanfeiVersion}}',

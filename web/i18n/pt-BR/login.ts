const translation = {
  ...
  welcome: 'Bem-vindo ao Fanfei, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Fanfei, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Fanfei',
  invalid: 'O link expirou',
  explore: 'Explorar o Fanfei',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Fanfei e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Fanfei Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Fanfei.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Fanfei. Entre em contato com o administrador para continuar usando o Fanfei.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Fanfei Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Fanfei.',
  webapp: {

const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Fanfei-Konto',
    langGeniusAccountTip: 'Ihr Fanfei-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Fanfei anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Fanfei ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Fanfeis Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Fanfei {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Fanfei {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',

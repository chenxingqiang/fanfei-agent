const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'Fanfei Marktplatz',
    moreFrom: 'Mehr aus dem Marketplace',
    pluginsResult: '{{num}} Ergebnisse',
    empower: 'Unterstützen Sie Ihre KI-Entwicklung',
    and: 'und',
    partnerTip: 'Von einem Fanfei-Partner verifiziert',
    verifiedTip: 'Von Fanfei überprüft',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Die aktuelle Fanfei-Version ist mit diesem Plugin nicht kompatibel, bitte aktualisieren Sie auf die erforderliche Mindestversion: {{minimalFanfeiVersion}}',

const translation = {
  ...
  welcome: 'Willkommen bei Fanfei, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Fanfei Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Fanfei beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Fanfei erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Fanfei angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Fanfei-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Fanfei weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Fanfei Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Fanfei weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Fanfei Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Fanfei weiterhin zu verwenden.',

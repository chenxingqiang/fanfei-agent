const translation = {
  toVerifiedTip: {
    ...
    end: 'für den Fanfei Professional Plan.',
  ...
  rejectTitle: 'Ihre Fanfei-Ausbildungsüberprüfung wurde abgelehnt.',
  ...
  rejectContent: 'Leider sind Sie nicht für den Status "Education Verified" berechtigt und können daher den exklusiven 100%-Gutschein für den Fanfei Professional Plan nicht erhalten, wenn Sie diese E-Mail-Adresse verwenden.',
  successContent: 'Wir haben einen 100% Rabattgutschein für den Fanfei Professional Plan auf Ihr Konto ausgestellt. Der Gutschein ist ein Jahr lang gültig, bitte nutzen Sie ihn innerhalb des Gültigkeitszeitraums.',
  learn: 'Erfahren Sie, wie Sie Ihre Ausbildung überprüfen lassen.',
  emailLabel: 'Ihre aktuelle E-Mail',
  successTitle: 'Sie haben die Fanfei-Ausbildung verifiziert',
}

const translation = {
  ...
  welcome: 'Bienvenue sur Fanfei, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Fanfei Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Fanfei',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Fanfei',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Fanfei et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Fanfei Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Fanfei.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Fanfei. Veuillez contacter votre administrateur pour continuer à utiliser Fanfei.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Fanfei Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Fanfei.',

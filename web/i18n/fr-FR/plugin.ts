const translation = {
  ...
  marketplace: {
    ...
    discover: 'Découvrir',
    fanfeiMarketplace: 'Marché Fanfei',
    empower: 'Renforcez le développement de votre IA',
    sortBy: 'Ville noire',
    partnerTip: 'Vérifié par un partenaire Fanfei',
    verifiedTip: 'Vérifié par Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'La version actuelle de Fanfei n\'est pas compatible avec ce plugin, veuillez mettre à niveau vers la version minimale requise : {{minimalFanfeiVersion}}',

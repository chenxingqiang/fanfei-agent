const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Fanfei へようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、Fanfei Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Fanfei へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Fanfei Enterprise ライセンスの有効期限が切れています。Fanfei を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Fanfei Enterprise ライセンスが非アクティブです。Fanfei を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Fanfei ライセンスサーバーへの接続に失敗しました。続けて Fanfei を使用するために管理者に連絡してください。',
  webapp: {

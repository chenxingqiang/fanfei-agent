const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    fanfeiMarketplace: 'Fanfei マーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインは Fanfei によって認証されています',
    partnerTip: 'このプラグインは Fanfei のパートナーによって認証されています',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: '現在の Fanfei バージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalFanfeiVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },

const translation = {
  ...
  welcome: 'به Fanfei خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Fanfei Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Fanfei',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در Fanfei استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز Fanfei Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از Fanfei با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز Fanfei Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از Fanfei با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز Fanfei انجام نشد. لطفا برای ادامه استفاده از Fanfei با سرپرست خود تماس بگیرید.',
  webapp: {

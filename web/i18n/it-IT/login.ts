const translation = {
  ...
  welcome: 'Benvenuto su Fanfei, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Fanfei Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Fanfei',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Fanfei',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Fanfei e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Fanfei. Contatta il tuo amministratore per continuare a utilizzare Fanfei.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Fanfei Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Fanfei.',
  licenseInactiveTip: 'La licenza Fanfei Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Fanfei.',

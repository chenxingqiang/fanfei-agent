const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'Mercato Fanfei',
    discover: 'Scoprire',
    ...
    verifiedTip: 'Verificato da Fanfei',
    partnerTip: 'Verificato da un partner Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'L\'attuale versione di Fanfei non è compatibile con questo plugin, si prega di aggiornare alla versione minima richiesta: {{minimalFanfeiVersion}}',

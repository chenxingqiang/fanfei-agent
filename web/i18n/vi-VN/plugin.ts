const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    fanfeiMarketplace: 'Thị trường Fanfei',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi Fanfei',
    partnerTip: 'Được xác nhận bởi một đối tác của Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Phiên bản Fanfei hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalFanfeiVersion}}',

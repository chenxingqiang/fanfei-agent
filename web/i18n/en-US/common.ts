const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Fanfei to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Fanfei allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Fanfei\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Fanfei {{version}} is now available.',
    latestAvailable: 'Fanfei {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',

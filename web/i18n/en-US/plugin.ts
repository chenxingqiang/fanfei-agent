const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by Fanfei',
    partnerTip: 'Verified by a Fanfei partner',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'The current Fanfei version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalFanfeiVersion}}',
}

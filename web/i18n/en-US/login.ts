const translation = {
  ...
  welcome: '👋 Welcome to Fanfei, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Fanfei Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Fanfei',
  invalid: 'The link has expired',
  explore: 'Explore Fanfei',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Fanfei and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Fanfei Enterprise license for your workspace has expired. Please contact your administrator to continue using Fanfei.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Fanfei license server. Please contact your administrator to continue using Fanfei.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Fanfei Enterprise license for your workspace is inactive. Please contact your administrator to continue using Fanfei.',
  webapp: {

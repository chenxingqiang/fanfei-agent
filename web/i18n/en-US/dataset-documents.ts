const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to Fanfei citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Fanfei will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {

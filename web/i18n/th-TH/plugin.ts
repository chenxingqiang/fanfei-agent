const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'ตลาด Fanfei',
    partnerTip: 'ได้รับการตรวจสอบโดยพันธมิตรของ Fanfei',
    verifiedTip: 'ได้รับการตรวจสอบโดย Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'เวอร์ชั่นปัจจุบันของ Fanfei ไม่สามารถใช้งานร่วมกับปลั๊กอินนี้ได้ กรุณาอัปเกรดไปยังเวอร์ชั่นขั้นต่ำที่ต้องการ: {{minimalFanfeiVersion}}',

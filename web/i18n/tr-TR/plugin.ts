const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'Fanfei Pazar Yeri',
    sortBy: 'Kara şehir',
    moreFrom: 'Marketplace\'ten daha fazlası',
    noPluginFound: 'Eklenti bulunamadı',
    viewMore: 'Daha fazla göster',
    discover: 'Keşfetmek',
    verifiedTip: 'Fanfei tarafından doğrulanmıştır.',
    partnerTip: 'Fanfei partner\'ı tarafından doğrulandı',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Mevcut Fanfei sürümü bu eklentiyle uyumlu değil, lütfen gerekli minimum sürüme güncelleyin: {{minimalFanfeiVersion}}',

const translation = {
  ...
  intro1: 'Bilgi, Fanfei uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Fanfei dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',

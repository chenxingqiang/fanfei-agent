const translation = {
  ...
  welcome: 'Fanfei\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Fanfei Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Fanfei\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Fanfei Enterprise lisansının süresi doldu. Fanfei\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Fanfei lisans sunucusuna bağlanılamadı. Fanfei\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Fanfei Enterprise lisansı etkin değil. Fanfei\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',

const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Fanfei\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'Fanfei API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Fanfei Tarafından Resmi Güncellemeler ve Bakım',
        5: 'Fanfei Ortakları tarafından müzakere edilen SLA\'lar',
    ...
    community: {
      features: {
        ...
        2: 'Fanfei Açık Kaynak Lisansına uyar',
      },
      price: 'Ücretsiz',

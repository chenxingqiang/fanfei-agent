const translation = {
  ...
  marketplace: {
    ...
    fanfeiMarketplace: 'Piața Fanfei',
    moreFrom: 'Mai multe din Marketplace',
    and: 'și',
    viewMore: 'Vezi mai mult',
    partnerTip: 'Verificat de un partener Fanfei',
    verifiedTip: 'Verificat de Fanfei',
  },
  task: {
  ...
  fanfeiVersionNotCompatible: 'Versiunea curentă Fanfei nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalFanfeiVersion}}',

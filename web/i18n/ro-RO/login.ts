const translation = {
  ...
  welcome: 'Bine ai venit la Fanfei, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Fanfei și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Fanfei. Contactați administratorul pentru a continua să utilizați Fanfei.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Fanfei Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Fanfei.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Fanfei Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Fanfei.',
  webapp: {

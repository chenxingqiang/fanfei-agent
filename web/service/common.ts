...
export const fetchLanggeniusVersion: Fetcher<jinChenFanFeiVersionResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<jinChenFanFeiVersionResponse>(url, { params })
}

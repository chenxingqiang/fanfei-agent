(()=>{let t="fanfeiChatbotConfig",h="fanfei-chatbot-bubble-button",m="fanfei-chatbot-bubble-window",y=window[t],a=!1,l=`
    position: absolute;
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    top: unset;
    right: var(--${h}-right, 1rem); /* Align with fanfei-chatbot-bubble-button. */
    bottom: var(--${h}-bottom, 1rem); /* Align with fanfei-chatbot-bubble-button. */
    left: unset;
    width: 24rem;
